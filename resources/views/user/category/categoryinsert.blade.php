                                ...
                                <div class="col-lg-12">
                                    <div class="card border-0 rounded-lg mt-2">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('user.category.categoryinsert') }}" method="POST">
                                                @csrf
                                                <div class="form-group">
                                                    <label class="small mb-1" for="inputEmailAddress">Category Name</label>
                                                    <input class="form-control py-4" id="inputEmailAddress" name="name" type="text" placeholder="Enter Category" autofocus required />
                                                </div>
